...
import { ArrowRight, Code2, Terminal, BookOpen, CheckCircle2, ShieldCheck, Zap } from 'lucide-react';
              ...
              {activeTab === 'preview' && (
                <div className="space-y-4 font-sans">
                  <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-mono flex items-center justify-between">
                    ...
                    <span className="text-[#86868B]">18ms</span>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="p-5 rounded-2xl bg-zinc-900/60 border border-white/10">
                      <div className="text-xs text-[#86868B]">O'zlashtirish Darajasi</div>
                    ...
                    <div className="p-5 rounded-2xl bg-zinc-900/60 border border-white/10">
                      <div className="text-xs text-[#86868B]">Tayyor Loyihalar</div>
                      <div className="text-3xl font-extrabold text-[#FF6A00] mt-1">6 Loyiha</div>
                      <div className="text-xs text-[#86868B] mt-1">GitHub & Vercel live</div>
                    </div>
                    <div className="p-5 rounded-2xl bg-zinc-900/60 border border-white/10">
                      <div className="text-xs text-[#86868B]">Mentorlik Bahosi</div>
                      <div className="text-3xl font-extrabold text-emerald-400 mt-1">5.0 / 5</div>
                      <div className="text-xs text-[#86868B] mt-1">100% Amaliy ko'mak</div>
                    </div>
                  </div>
                </div>
              )}
