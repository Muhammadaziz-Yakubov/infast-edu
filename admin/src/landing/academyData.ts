...
export const MENTORS: Mentor[] = [
  {
    ...
    role: "Asoschi & Bosh Dasturlash Mentori",
    experience: "5+ yil tajriba",
    company: "InFast IT-Academy Asoschisi",
    bio: "InFast IT-Academy asoschisi va InFast OS raqamli ta'lim ekotizimi muallifi. Full-Stack va Mobile yo'nalishlarida ko'p yillik amaliy tajribaga ega bo'lib, yuzlab muvaffaqiyatli bitiruvchilar ustozidir.",
    avatar: "/my.jpg",
    skills: ["Next.js", "NestJS", "TypeScript", "React Native", "System Design", "AI Automation"],
    social: {
      github: "https://github.com/Muhammadaziz-Yakubov",
      linkedin: "https://www.linkedin.com/in/muhammadazizyakubov/",
